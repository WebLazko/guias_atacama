...
<div class="container-fluid">
  <nav id="barra_navegacion_inicio" class="row navbar navbar-expand-md navbar-dark d-lg-none d-sm-none">
...
<nav id="barra_navegacion_todo" class="row navbar navbar-expand-md navbar-dark">
  ...
  <div id="row_carrusel" class="col-md-12" style="background-color: #f6902a">
    <div class="wrapper" id="wrapper_carrusel">
            <div id="jcarousel_wrapper_header" class="jcarousel-wrapper">
  ...
  <div class="row" style="background: white;">
    ...
    <div id="cuerpo" class="col-xs-10 col-sm-9 col-lg-9 d-none d-lg-block d-sm-block"  style="/*height: 700px;*/background-color:#EDEFE8;">@yield('contenido')</div>


    <div id="cuerpo2" class="col-xs-2 col-sm-12 d-lg-none"  style="/*height: 700px;*/background-color:#EDEFE8;">@yield('contenido-responsive')</div>
